...
pixi global install weasyprint
```
...
It is possible to list all of the versions of `weasyprint` available on your platform:
...
```
pixi search weasyprint --channel conda-forge
```
